...
public partial class EcodbContext : DbContext
{
    ...
    public virtual DbSet<DiscountsHistory> DiscountsHistories { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<DiscountsHistory>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("discounts_history_pkey");

            entity.ToTable("discounts_history");
            ...
            entity.HasOne(d => d.Discount).WithMany(p => p.DiscountsHistories)
                .HasForeignKey(d => d.DiscountId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("discounts_history_discount_id_fkey");

            entity.HasOne(d => d.User).WithMany(p => p.DiscountsHistories)
                .HasForeignKey(d => d.UserId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("discounts_history_user_id_fkey");
        });
        ...
        modelBuilder.Entity<WasteDisposal>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("waste_disposal_pkey");

            entity.ToTable("waste_disposal");
            ...
            entity.HasOne(d => d.HazardousWaste).WithMany(p => p.WasteDisposals)
                .HasForeignKey(d => d.HazardousWasteId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("waste_disposal_hazardous_waste_id_fkey");

            entity.HasOne(d => d.User).WithMany(p => p.WasteDisposals)
                .HasForeignKey(d => d.UserId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("waste_disposal_user_id_fkey");
        });
